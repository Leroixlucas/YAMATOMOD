...
package net.mcreator.dmcyamato.world.features.ores;
...
public class DemonSoulFragmentOreFeature extends OreFeature {
	public static DemonSoulFragmentOreFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new DemonSoulFragmentOreFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("dmc_yamato:demon_soul_fragment_ore", FEATURE,
	...
	public DemonSoulFragmentOreFeature() {
